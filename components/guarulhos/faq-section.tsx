...
export function FAQSection({ whatsappUrl }: FAQSectionProps = {}) {
  ...
  const faqs = [
    {
      question: "Qual o prazo de entrega em Guarulhos?",
      answer:
        "Normalmente entregamos em até 24 horas após a confirmação do pedido. Para urgências, consulte nossa equipe pelo WhatsApp — muitas vezes conseguimos entrega no mesmo dia na região de Guarulhos e cidades vizinhas.",
    },
    {

      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-background/70 text-sm leading-relaxed">
              Locação de andaimes e equipamentos para construção civil em Guarulhos e região metropolitana. Segurança e qualidade para sua obra.
            </p>
          </div>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 text-center">
          ...
          <p className="text-background/50 text-xs mt-2">
            Aluguel de andaimes em Guarulhos | Região Metropolitana de São Paulo
          </p>
        </div>
      </div>
    </footer>
